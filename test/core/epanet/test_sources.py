...
class SimpleSourcesTest(unittest.TestCase):
    ...
    def runTest(self):
        ...
        assert project_sources.value[1].node_id == "JUNCTION-9091"
        ...
        assert project_sources.value[2].node_id == "JUNCTION-9092"
        ...
        assert project_sources.value[3].node_id == "JUNCTION-9093"
