...
class Ui_frmClimatology(object):
    ...
    def retranslateUi(self, frmClimatology):
        ...
        self.rbnExternal.setText(_translate("frmClimatology", "External Climate File", None))
        ...
        self.lblSnowLongitude.setText(_translate("frmClimatology", "Longitude Correction (+/- minutes)", None))
