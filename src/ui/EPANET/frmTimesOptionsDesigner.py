...
class Ui_frmTimesOptions(object):
    def setupUi(self, frmTimesOptions):
        ...
        self.lblTotalDuration = QtGui.QLabel(self.fraTop)
        font = QtGui.QFont()
        font.setPointSize(10)
