...
class Ui_frmFind(object):
    def setupUi(self, frmFind):
        ...
        self.centralWidget = QWidget(frmFind)
        self.centralWidget.setObjectName(_fromUtf8("centralWidget"))
        self.gridLayout = QGridLayout(self.centralWidget)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.gbxID = QGroupBox(self.centralWidget)
        self.gbxID.setObjectName(_fromUtf8("gbxID"))
        self.verticalLayout_3 = QVBoxLayout(self.gbxID)
        self.verticalLayout_3.setObjectName(_fromUtf8("verticalLayout_3"))
        self.txtID = QLineEdit(self.gbxID)
        ...
        self.gbxAdjacent = QGroupBox(self.centralWidget)
        self.gbxAdjacent.setObjectName(_fromUtf8("gbxAdjacent"))
        self.verticalLayout_4 = QVBoxLayout(self.gbxAdjacent)
        self.verticalLayout_4.setObjectName(_fromUtf8("verticalLayout_4"))
        self.lstAdjacent = QListWidget(self.gbxAdjacent)
