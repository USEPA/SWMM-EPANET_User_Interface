...
STYLES = {
    'keyword': make_char_format('blue'),
    'operator': make_char_format('red'),
    'brace': make_char_format('darkGray'),
    'defclass': make_char_format('black', 'bold'),
    'string': make_char_format('magenta'),
    'string2': make_char_format('darkMagenta'),
    'comment': make_char_format('darkGreen', 'italic'),
    'self': make_char_format('black', 'italic'),
    'numbers': make_char_format('brown'),
}
