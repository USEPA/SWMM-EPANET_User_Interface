...
class Ui_frmClimatology(object):
    def setupUi(self, frmClimatology):
        ...
        self.btnEvapDelete = QtGui.QToolButton(self.fraEvapTop)
        self.btnEvapDelete.setObjectName(_fromUtf8("btnEvapDelete"))
        self.gridLayout_10.addWidget(self.btnEvapDelete, 2, 2, 1, 1)
    ...
    def retranslateUi(self, frmClimatology):
        ...
        self.btnEvapDelete.setText(_translate("frmClimatology", "...", None))
        ...
        self.btnPerNo.setText(_translate("frmClimatology", "No Depletion", None))
        self.btnImpNat.setText(_translate("frmClimatology", "Natural Area", None))
        self.btnImpNo.setText(_translate("frmClimatology", "No Depletion", None))
