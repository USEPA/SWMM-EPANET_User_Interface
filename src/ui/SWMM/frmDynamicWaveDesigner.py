...
class Ui_frmDynamicWave(object):
    def setupUi(self, frmDynamicWave):
        ...
        self.cbxInertial = QtGui.QComboBox(self.centralWidget)
        self.cbxInertial.setGeometry(QtCore.QRect(210, 20, 151, 22))
        self.cbxInertial.setObjectName(_fromUtf8("cbxInertial"))
        ...
        self.cbxNormal = QtGui.QComboBox(self.centralWidget)
        self.cbxNormal.setGeometry(QtCore.QRect(210, 60, 151, 22))
        self.cbxNormal.setObjectName(_fromUtf8("cbxNormal"))
        ...
        self.cbxForce = QtGui.QComboBox(self.centralWidget)
        self.cbxForce.setGeometry(QtCore.QRect(210, 100, 151, 22))
        self.cbxForce.setObjectName(_fromUtf8("cbxForce"))
