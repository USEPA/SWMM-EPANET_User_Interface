...
class Ui_frmInflows(object):
    def setupUi(self, frmInflows):
        ...
        self.gridLayout.addWidget(self.lblConstituent, 0, 0, 1, 2)
        self.lblScaleFactor = QtGui.QLabel(self.fraDirect)
        self.lblScaleFactor.setObjectName(_fromUtf8("lblScaleFactor"))
        self.gridLayout.addWidget(self.lblScaleFactor, 5, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.lblTimeseries, 4, 0, 1, 2)
