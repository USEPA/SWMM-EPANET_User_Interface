...
class Ui_frmDynamicWave(object):
    def setupUi(self, frmDynamicWave):
        ...
        self.centralWidget = QWidget(frmDynamicWave)
        ...
        self.formLayout_2 = QFormLayout(self.frame1)
        self.formLayout_2.setObjectName(_fromUtf8("formLayout_2"))
        self.lblInertial = QLabel(self.frame1)
        self.lblInertial.setObjectName(_fromUtf8("lblInertial"))
        self.formLayout_2.setWidget(0, QFormLayout.LabelRole, self.lblInertial)
        self.cboInertial = QComboBox(self.frame1)
        ...
        self.formLayout_2.setWidget(0, QFormLayout.FieldRole, self.cboInertial)
        self.lblNormal = QLabel(self.frame1)
        self.lblNormal.setObjectName(_fromUtf8("lblNormal"))
        self.formLayout_2.setWidget(1, QFormLayout.LabelRole, self.lblNormal)
        self.cboNormal = QComboBox(self.frame1)
        ...
        self.formLayout_2.setWidget(1, QFormLayout.FieldRole, self.cboNormal)
        self.lblForce = QLabel(self.frame1)
        self.lblForce.setObjectName(_fromUtf8("lblForce"))
        self.formLayout_2.setWidget(2, QFormLayout.LabelRole, self.lblForce)
        self.cboForce = QComboBox(self.frame1)
        ...
        self.formLayout_2.setWidget(2, QFormLayout.FieldRole, self.cboForce)
        ...
        self.cbxUseVariable = QCheckBox(self.frame2)
        ...
        self.formLayout = QFormLayout(self.frame3)
        self.formLayout.setObjectName(_fromUtf8("formLayout"))
        self.lblMinimum = QLabel(self.frame3)
        self.lblMinimum.setObjectName(_fromUtf8("lblMinimum"))
        self.formLayout.setWidget(0, QFormLayout.LabelRole, self.lblMinimum)
        self.txtMinimum = QLineEdit(self.frame3)
        self.txtMinimum.setObjectName(_fromUtf8("txtMinimum"))
        self.formLayout.setWidget(0, QFormLayout.FieldRole, self.txtMinimum)
        self.lblTimeStep = QLabel(self.frame3)
        self.lblTimeStep.setObjectName(_fromUtf8("lblTimeStep"))
        self.formLayout.setWidget(1, QFormLayout.LabelRole, self.lblTimeStep)
        self.txtLengthening = QLineEdit(self.frame3)
        self.txtLengthening.setObjectName(_fromUtf8("txtLengthening"))
        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.txtLengthening)
        self.lblSurface = QLabel(self.frame3)
        self.lblSurface.setObjectName(_fromUtf8("lblSurface"))
        self.formLayout.setWidget(2, QFormLayout.LabelRole, self.lblSurface)
        self.txtSurfaceArea = QLineEdit(self.frame3)
        self.txtSurfaceArea.setObjectName(_fromUtf8("txtSurfaceArea"))
        self.formLayout.setWidget(2, QFormLayout.FieldRole, self.txtSurfaceArea)
        self.lblMaximum = QLabel(self.frame3)
        self.lblMaximum.setObjectName(_fromUtf8("lblMaximum"))
        self.formLayout.setWidget(3, QFormLayout.LabelRole, self.lblMaximum)
        self.sbxTrials = QSpinBox(self.frame3)
        self.sbxTrials.setObjectName(_fromUtf8("sbxTrials"))
        self.formLayout.setWidget(3, QFormLayout.FieldRole, self.sbxTrials)
        self.lblHead = QLabel(self.frame3)
        self.lblHead.setObjectName(_fromUtf8("lblHead"))
        self.formLayout.setWidget(4, QFormLayout.LabelRole, self.lblHead)
        self.txtTolerance = QLineEdit(self.frame3)
        self.txtTolerance.setObjectName(_fromUtf8("txtTolerance"))
        self.formLayout.setWidget(4, QFormLayout.FieldRole, self.txtTolerance)
        self.lblThreads = QLabel(self.frame3)
        self.lblThreads.setObjectName(_fromUtf8("lblThreads"))
        self.formLayout.setWidget(5, QFormLayout.LabelRole, self.lblThreads)
        self.cboThreads = QComboBox(self.frame3)
        self.cboThreads.setObjectName(_fromUtf8("cboThreads"))
        self.formLayout.setWidget(5, QFormLayout.FieldRole, self.cboThreads)
        ...
        spacerItem1 = QSpacerItem(142, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)
