...
class ProjectTest(unittest.TestCase):
    ...
    def runTest(self):
        ...
        exe_path = os.path.join(source_root_path, "src", "Externals", "epanet", "model")
        ...
        html_file = os.path.join(directory, 'Test_Example_Summaries_EPANET.html')
                ...
                if extension.lower() == ".inp":
                    ...
                    if number_of_sections == new_number_of_sections:
                        ...
                        if os.path.isfile(original_) and os.path.isfile(copy_):
                            ...
                            diff_msg = ProjectTest.compare_two_analysis_blocks(original_, copy_, exempted_strings)
                            if diff_msg:
                                msg = prefix + '.rpt:'\
                                      +'results of modified differ from results of original'+'\n'\
                                      + diff_msg + '\n'
